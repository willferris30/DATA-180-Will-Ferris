...
ggplot(Cars93, aes(x = EngineSize, y = MPG.city)) +
  ...
  # Add points with blue color and size = 2
  geom_point(color = "blue", size = 2) +
  xlim(0, max(Cars93$EngineSize) + 1) +
  ylim(0, max(Cars93$MPG.city) + 5) +
  labs(
    title = "Scatterplot of Engine Size vs. MPG City",
    subtitle = "ggplot2",
    x = "Engine Size",
    y = "MPG City",
    caption = "Data 180 HW 3"
  )
```
...
ggplot(Cars93, aes(x = AirBags, fill = AirBags)) +
  ...
  labs(
    title = "Barplot of Car Count by AirBags",
    subtitle = "ggplot2",
    x = "AirBags",
    y = "Count",
    caption = "Data 180 HW 3"
...
ggplot(Cars93, aes(x = Origin, fill = AirBags)) +
  ...
  labs(
    title = "Grouped Barplot of Car Count by Origin and AirBags",
    subtitle = "ggplot2",
    x = "Origin",
    y = "Count",
    caption = "Data 180 HW 3"
...
ggplot(au_states, aes(fill = NAME)) +
  ...
  theme_minimal() +
  ggtitle("Map of Australia") +
  scale_fill_manual(values = rainbow(nrow(au_states)))
```
## Task 3
...
```{r}
ggplot() +
  geom_sf(data = au_states, aes(fill = NAME), color = "black") +
  geom_point(data = au_capitals, aes(x = lon, y = lat), col = "red", size = 2) +
  theme_minimal() +
  ggtitle("Map of Australia with Capitals") +
  scale_fill_manual(values = rainbow(nrow(au_states)))
```
...
library(mapview)
capitals_geo
mapview(au_states) + mapview(col.regions='red', legend = F)
```
